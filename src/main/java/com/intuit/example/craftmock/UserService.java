package com.intuit.example.craftmock;
...
public class UserService {
    ...
    public UserService() {
        users = Arrays.stream(new User[]{
                ...
                new User(UUID.fromString("f256c996-6dcb-40cf-8dce-a11fa9bcab6b"), "Antonio Smith", "antoniosmith@test.com", "Test Lane 4 Los Angeles"),
